...
<body>
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('gallery.store')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\xampp\htdocs\application-app\resources\views/gallery/create.blade.php ENDPATH**/ ?>